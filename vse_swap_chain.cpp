...
VkResult VseSwapChain::acquireNextImage(uint32_t *imageIndex) {
...
VkResult VseSwapChain::submitCommandBuffers(const VkCommandBuffer *buffers,
                                            uint32_t *imageIndex) {
...
void VseSwapChain::createSwapChain() {
...
void VseSwapChain::createRenderPass() {
...
void VseSwapChain::createFramebuffers() {
...
void VseSwapChain::createDepthResources() {
...
void VseSwapChain::createSyncObjects() {
...
VkPresentModeKHR VseSwapChain::chooseSwapPresentMode(
...
VkExtent2D VseSwapChain::chooseSwapExtent(
...
VkFormat VseSwapChain::findDepthFormat() {
