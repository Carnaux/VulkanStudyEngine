...
SimpleRenderSystem::SimpleRenderSystem(VseDevice& device,
...
void SimpleRenderSystem::renderGameObjects(
    VkCommandBuffer commandBuffer, std::vector<VseGameObject>& gameObjects) {
  vsePipeline->bind(commandBuffer);
